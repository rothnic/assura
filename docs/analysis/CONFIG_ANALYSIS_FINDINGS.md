...
⚠️  WARNING: Root file 'CONFIG_ANALYSIS_FINDINGS.md' violates policy
   ...
   Suggestion: Move to docs/analysis/CONFIG_ANALYSIS_FINDINGS.md
...
| PERFORMANCE_BASELINE.md | Root | ❌ docs/ | Move |
...
| PERFORMANCE_BASELINE.md | Metrics | ❌ No | Move to docs/ |
...
mv PERFORMANCE_BASELINE.md docs/performance/
...
❌ ERROR: 1 violation(s) found
  ...
  docs/analysis/CONFIG_ANALYSIS_FINDINGS.md
