...
| `assura agent onboard` | Experimental local agent-ready onboarding surface | Project-intelligence onboarding tests prove the command generates a broad baseline, onboarding packet, checked/unchecked report, and non-destructive existing-file behavior. |
