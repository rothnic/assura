...
| 2026-06-01 | Confirmed clean-checkout CI for PR #18. | GitHub checks passed: Build Documentation, Check, Clippy, Code Coverage, GitGuardian Security Checks, Performance Report, Release Bundle Smoke, Rustfmt, macOS tests, Ubuntu tests, Windows Installer Smoke. |
