...
- Document how the preset composes with agent-project and common project-type
  specialization.

## Non-Goals

- No project-type scoring in the generic document-project preset.
...
Block if the preset hardcodes domain-specific assumptions, reads binary files as
