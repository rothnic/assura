---
title: 'Implementation Gaps Report'
status: historical
---

# Implementation Gaps Report

This document tracks the current implementation status of features defined in the [Configuration Specification](./configuration-spec.md).
