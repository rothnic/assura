...
- The smallest acceptable hook path is enhancing the existing `assura hooks` surface with a tested `verify` command rather than adding a separate daemon or hidden agent service.
