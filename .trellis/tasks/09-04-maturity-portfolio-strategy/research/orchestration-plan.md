...
## Latest observed integration route — PR #324 — `74f565c` (2026-09-12; current source)
...
- PR #324 merged the reviewed source-pointer reconciliation from head
  ...
  Rust CI `34684935294` (Evidence Gates job `103530193780`) passed for
  applicable scope. Scope-skipped product, Rust, performance and release rows
  remain non-proof.
- The refreshed ledger is `items=32; ready_pending=0; unfinished=4; held=2`:
  R01 is terminal `not_needed` under H01, A07 is active/no-credit with no live
  candidate, W02/F01 remain held and W03 publication remains separately
  authorized. PR #323 and earlier source pointers are historical; refresh source, release/tag, PR/CI,
  topology and ledger before every phase. No process pass or skipped check
  grants screening, allocation, credit, acceptance, release, deployment,
  publication, invitation or protection authority.

## Historical integration route — PR #323 — `b286c82` (2026-09-12; superseded by PR #324)

- PR #323 merged the reviewed recovery-entry correction as
  `b286c8272466ca980267c4b3858833bd7da74f8b` from
  `feeb3640c19ed46f930fd14f4a1a7684ad0a85f6`; its scoped review and applicable
  hosted gates passed. It is preserved as a process-only historical checkpoint.

## Historical integration route — PR #322 — `600e9cd` (2026-09-12; superseded by PR #323)
...
- PR #322 merged the reviewed route correction from head
  ...
  PASS and resolved `TRAIN-ROUTE-3834-002`, the stale PR #307 reference in the
  A07 binding packet. Exact-head Evidence Gates, CI Scope, Documentation Scope,
...
- The refreshed ledger is `items=32; ready_pending=0; unfinished=4; held=2`:
  R01 is terminal `not_needed` under H01, A07 is active/no-credit with no live
  candidate, W02/F01 remain held and W03 publication remains separately
  authorized. PR #321 is historical; refresh source, release/tag, PR/CI,
  topology and ledger before every phase. No process pass or skipped check
  grants screening, allocation, credit, acceptance, release, deployment,
  publication, invitation or protection authority.

## Historical integration route — PR #321 — `3834b1b` (2026-09-12; superseded by PR #322)
