...
## Historical post-merge route — PR #322 — 2026-09-12 UTC (`origin/master=600e9cd`; superseded by PR #323)
...
- PR #307 merged reviewed process artifacts from head
  ...
  `eef7e1a7400c84ec35be33a58914ad07da7fa376`. Exact-head Documentation, CI
  ...
  Rust CI `34660366735` passed. Current merge tree is
  `1bfbcc27e5504ff23af489c1d076c4f6aba448a0`.
- Before A07 screening or acceptance, refresh source/release/tag, PR/CI,
...
## Historical post-merge route — PR #306 — 2026-09-11 UTC (`origin/master=66e0b7e`; superseded by eef7e1a)

PR #306 merged the reviewed process slice at `66e0b7e`; its applicable hosted
gates passed and it classified the `dc031527` candidate and packet as
...
the merge tree, and the configured push-triggered Rust CI (`34635475363`),
Documentation (`34635475400`) and Security Audit (`34635475378`) workflows
...
## Historical candidate-binding checkpoint — 2026-09-11 UTC (`origin/master=4560c710`, superseded by `651ef31`)
...
## Historical post-merge checkpoint — 2026-09-11 UTC (`origin/master=329bce0`, superseded by `651ef31`)

PR #298 merged the reviewed current-checkpoint reconciliation at `329bce0`.
Its exact-head and merge-SHA checks passed; this is historical process
evidence only. Refresh to `651ef31` before any candidate or authority action.

## Historical post-merge checkpoint — 2026-09-11 UTC (`origin/master=6d57b86`, superseded by `329bce0`)

PR #297 merged the reviewed current-checkpoint reconciliation at `6d57b86`.
Its exact-head applicable checks and merge-SHA workflows passed; this is
historical process evidence only. Refresh to `651ef31` before any candidate or
authority action.

## Historical post-merge checkpoint — 2026-09-11 UTC (`origin/master=40f1155c`, superseded by `651ef31`)
...
PR #288 merged the durable-goal artifacts. The ac3, ca816 and 851a6 candidates,
canaries, identity controls, six-handle binding, manifest and isolated protocol
`PASS` record are candidate-base/no-credit metadata after those source advances. No
current candidate or screening allocation exists. Refresh
source/release/tag/PR/CI/topology and the ledger, then build and freeze a fresh
explicit-workdir candidate before seeking separately authorized screening.
Preserve failures and authority boundaries; do not reuse the 851a6 packet.
