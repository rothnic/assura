# Maturity execution train progress — early history

This preserves the completed initial B00/R01 execution records that were
archived from the live journal when it reached its configured line limit.
