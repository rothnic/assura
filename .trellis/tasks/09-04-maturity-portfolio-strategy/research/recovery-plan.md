...
## Current recovery route — 36e5a840 — 2026-09-12 UTC (post-merge candidate-bound no-credit)
PR #310 merged reviewed process evidence at `36e5a84024b1680b887bd789ed89ec8a0490f30f` (tree `292936709bd59a9f87531e7b0fb5d77826eb8751`); applicable Documentation, Security Audit and Rust CI merge-SHA workflows passed. Ledger: `items=32; ready_pending=0; unfinished=5; held=3` (A07 active, W03 verified, R01/W02/F01 held); 9c1 is candidate-base/no-credit.
Fresh `/private/tmp/assura-train-postmerge-36e5` uses exact Rust/Cargo `1.94.1`, binary/shim `7144ed4b77096daf6efe3419bf14a7df59bab5adc33e48444390a618344be87d`, and passing identity/negative controls. Retain the prior empty-fixture preservation/native failure as unfavorable evidence; fresh seeded, sibling-free A/B retries pass all seven dimensions, native tests, negative rejection and preservation hashes.
Summary: `screening/canary-2026-09-12-current-36e5.json`. Private packet: six holdouts, two conditions, 30 cells; `valid=true`, protocol `PASS_NO_CREDIT` after correcting the final construction digest binding; reviewer artifact `screening/protocol-review-2026-09-12-current-36e5-r1.json` SHA `a5e51d32930603645e582bb8ef00ea559568d96d59fca1d3c30a7764745fd4e8`, all credit/authority false. VPS is held (`vps-dev` unresolved; `vps` 95% root/nightly toolchain). Next: publish a redacted pointer through review/gates, merge, observe merge-SHA workflows, then refresh/rebuild before screening.
...
current-checkpoint reconciliation, and PR #299 most recently reconciled it
from reviewed head `c6a47ae4e486d4d226a747a3f49653c235f251d1`; its exact-head applicable
Documentation, CI Scope, Security Scope, Evidence Gates and GitGuardian checks
passed, the reviewed tree equals the merge tree, and the configured
push-triggered Rust CI (`34635475363`), Documentation (`34635475400`) and
...
- Owner/phase: process coordinator / `post-merge-reconcile`. PR #259 merged
  ...
  `8c198dcb`) as `373fb01`; merged-tree equality passed. The applicable
  Documentation, CI, Evidence Gates, Security Scope and GitGuardian checks
  passed. Product, Rust, performance, release, installer and website jobs were
  scope-skipped and remain non-applicable, not acceptance proof.
- The revision-pinned ledger at `origin/master=373fb01` still has 32 items,
...
- The PR #258 `docs/maturity-goal-continuation` and PR #259
  ...
  proofs. The topology report completed; strict mode remains nonzero only for
  preserved root/user dirt, unrelated work, stale/prunable and unreadable
  registrations, and historical unmerged goal branches.
...
- This checkpoint records the state after PR #258 and before PR #259. Its
  `8c198dcb` pointer and pending-PR cleanup statement are historical; future
  continuations must use the live section above after fetching `origin/master`.
