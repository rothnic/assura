...
| 8 | Roadmap Iteration 01 | Active | `06-01-roadmap-phase-01-execution` |

## Active Epic

**Roadmap Iteration 01** is active.

Current owning task:
`.trellis/tasks/06-01-roadmap-phase-01-execution`.

Current branch:
`codex/phase-01-goal-02-policy-language`.

Current objective: execute the bounded Iteration 01 phase sequence with two-week
team goals. Goal 01 is complete; the active chunk is
`docs/goals/assura-goal-02-policy-language-completeness.md`. Completing
...
Continue with
`docs/goals/assura-goal-02-policy-language-completeness.md` under
