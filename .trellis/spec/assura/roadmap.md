...
Current branch:
`codex/phase-01-goal-05-installable-adoption-path`.

Current objective: execute the bounded Iteration 01 / Phase 01 sequence with
two-week team goals. Goals 01 through 04 are complete; the active chunk is
`docs/goals/assura-goal-05-installable-adoption-path.md`. Completing
...
Continue with
`docs/goals/assura-goal-05-installable-adoption-path.md` under
