...
Assura reports three kinds of evidence:

- headline cases: pinned real repositories in the `real-repo-headline` cohort
...
## Headline Pinned Repository Cases

The headline comparison uses pinned external repositories. They are cloned on
